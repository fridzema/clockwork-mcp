...
describe('Cache Tools', () => {
  ...
  describe('getCacheOperations', () => {
    it('returns all cache operations', () => {
      const result = getCacheOperations(getStorage(), { requestId: 'cache-req' });
  ...
  describe('getCacheStats', () => {
    it('returns cache statistics', () => {
      const result = getCacheStats(getStorage(), { requestId: 'cache-req' });
  ...
  describe('getRedisCommands', () => {
    it('returns redis commands', () => {
      const result = getRedisCommands(getStorage(), { requestId: 'cache-req' });
