...
describe('Context Tools', () => {
  ...
  describe('getLogs', () => {
    it('returns all logs', () => {
      const result = getLogs(getStorage(), { requestId: 'ctx-req' });
      expect(result).toHaveLength(4);
    });

    it('filters by minimum level', () => {
      const result = getLogs(getStorage(), { requestId: 'ctx-req', level: 'warning' });
  ...
  describe('getEvents', () => {
    it('returns all events', () => {
      const result = getEvents(getStorage(), { requestId: 'ctx-req' });
      expect(result).toHaveLength(2);
  ...
  describe('getViews', () => {
    it('returns all views', () => {
      const result = getViews(getStorage(), { requestId: 'ctx-req' });
      expect(result).toHaveLength(2);
    });
  });
  ...
  describe('getHttpRequests', () => {
    it('returns outgoing http requests', () => {
      const result = getHttpRequests(getStorage(), { requestId: 'ctx-req' });
